...
Bot Framework v4 bot tests for `rostbot` bot.
...
- [InitialDialog.test](dialogs/InitialDialog.test.js) shows how to write a simple data driven test for `InitialDialog` using a test case array.
