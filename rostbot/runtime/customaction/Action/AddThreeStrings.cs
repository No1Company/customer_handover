...
namespace Microsoft.BotFramework.Composer.CustomAction
{
    ...
    /// </summary>
    public class AddThreeStrings : Dialog
    {
        [JsonConstructor]
        public AddThreeStrings([CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
            : base()
        {
        ...
        [JsonProperty("$kind")]
        public const string Kind = "AddThreeStrings";
        ...
        /// </value>
        [JsonProperty("arg3")]
        public StringExpression Arg3 { get; set; }
        ...
        public override Task<DialogTurnResult> BeginDialogAsync(DialogContext dc, object options = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var arg3 = Arg3.GetValue(dc.State);

            var result = arg1 + arg2 + arg3 + "some completely unrelated stringvalue";
