...
def avail_times():
    times = [
            {
                "start" : d(2020, 11, 7, 14, 30),
                "stop"  : d(2020, 11, 7, 15, 30)
            },

            {
                "start" : d(2020, 11, 8, 11, 0),
                "stop"  : d(2020, 11, 8, 11, 30)
            },
            
            {
                "start" : d(2020, 11, 8, 14, 30),
                "stop"  : d(2020, 11, 8, 15, 30)
            },
            
            {
                "start" : d(2020, 11, 9, 8, 15),
                "stop"  : d(2020, 11, 9, 8, 45)
            },
            
            {
                "start" : d(2020, 11, 9, 10, 30),
                "stop"  : d(2020, 11, 9, 11, 00)
            }
        ]
